				...
				<div
					...
					<div style={{ padding: "0 20px", flexShrink: 0 }}>
						<p>
							...
							your <strong>Command Line Interface</strong> and <strong>Editor</strong>, it brings you the
							most powerful AI development experience. Thanks to all their <code>Clines</code>{" "}
							contributors!
						</p>
